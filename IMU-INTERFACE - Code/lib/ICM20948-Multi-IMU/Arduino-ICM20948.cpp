...
void ArduinoICM20948::initiliaze_I2C(uint8_t sda, uint8_t scl, int speed)
{
    i2c_int.begin(sda, scl, speed);
...
{
  //Serial.println("are you even calling me");
...
ArduinoICM20948::ArduinoICM20948(TwoWire &i2c_int):
  i2c_int(i2c_int)
{
}
...
int ArduinoICM20948::init(TwoWire &i2c_int, ArduinoICM20948Settings settings)
{
  ...
  //if(I2C_Address == 0x69){
    ...
    initiliaze_I2C(settings.sda_pin, settings.scl_pin, settings.i2c_speed);
    i2cScan();
  //}
